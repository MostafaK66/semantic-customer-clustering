...
def k_means():
    ...
    silhoutte_results = silhoutte_analysis.perform_combined_silhouette_analysis(data_no_outliers, k_range=settings.K2_RANGE, file_name='Kmeans_Silhouette_plot.png')
    ...
    plotter.plot_3d(df=df_pca_3d, title="PCA for KMeans Space")
    pca_analysis.save_eigenvalues_summary(pca_3d_object=pca_3d_object, file_name='eigenvalues_kmeans_pca.csv')
    ...
    tsne_analysis.save_tsne_embeddings(tsne_3d_object=tsne_3d_object, df=df_tsne_3d, file_name='tsne_embeddings_kmeans.csv')
